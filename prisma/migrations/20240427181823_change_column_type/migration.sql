/*
  ...
  - You are about to alter the column `access_token_token_expired` on the `Token` table. The data in that column could be lost. The data in that column will be cast from `String` to `DateTime`.
